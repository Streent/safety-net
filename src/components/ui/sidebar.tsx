...
// ScrollArea não será usada diretamente aqui, usaremos um div com overflow
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className={cn(
              "w-[--sidebar-width] bg-sidebar text-sidebar-foreground flex flex-col p-0", // p-0 to manage padding internally
              className
            )}
            style={
              {
          ...
          >
            ...
            {/* Use a div for scrolling content */}
            <div className="flex-1 overflow-y-auto p-4"> {/* Add padding here for the menu items */}
              {children}
            </div>
          </SheetContent>
        </Sheet>
